  ...
  return (
    <>
      <main className="flex h-screen gap-1 bg-marine-50 p-2">
        <SideBarCondominio />
        <div className="flex w-full flex-row items-start gap-3 self-stretch rounded-2xl bg-marine-700 p-4">
          <section className="flex h-full w-[95%] gap-5 pl-8">
            ...
            <div className="lista h-full w-[25rem] rounded-2xl bg-marine-900 px-8 shadow-2xl">
              <div className="input-group h-28 w-full pt-10">
                <span className="material-symbols-outlined absolute top-[70px] ml-2 text-xl">
                  search
                </span>
                <input
                  type="text"
