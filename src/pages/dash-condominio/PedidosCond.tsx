    ...
    return (
        ...
        <>
            <main className="flex p-2 h-screen gap-1 bg-marine-50">
                <SideBarCondominio />
                <div className="flex flex-col rounded-2xl gap-6 w-[70rem] justify-between items-start self-stretch py-3 px-2 bg-marine-700">
                    ...
                    <div className="flex flex-col items-start py-6 px-4 bg-moss-green-300 w-max h-5/6 rounded-2xl">
                        ...
                        <div className="flex bg-white h-screen w-[67rem] rounded-lg">
