  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-sm text-moss-green-500 font-medium',
        ...
        day_selected:
          'bg-moss-green-900 text-zinc-50 hover:bg-moss-green-900 hover:text-zinc-50 focus:bg-moss-green-900 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900',
        day_today:
          'bg-moss-green-700 text-zinc-50 dark:bg-zinc-800 dark:text-zinc-50',
        day_outside:
        ...
        day_range_middle:
          'aria-selected:bg-zinc-100 aria-selected:text-zinc-500 dark:aria-selected:bg-zinc-800 dark:aria-selected:text-zinc-50',
