    ...
    return (
        <nav className="relative z-10 flex min-w-full items-center justify-between bg-[#F1F1F1] px-28 py-3 shadow-lg">
            ...
            <div className="flex gap-6 font-mono text-sm">
                ...
                <button className="relative rounded-md bg-moss-green-500 px-6 py-2 text-zinc-50 transition-all duration-500 ease-out hover:bg-moss-green-800" onClick={handleLogin}>
                    Login
                </button>
            </div>
        </nav>
