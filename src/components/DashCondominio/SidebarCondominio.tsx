    ...
    return (
        <>
                ...
                <div className='flex w-56 max-h-[37.5rem] justify-between self-center flex-shrink-0 rounded-3xl bg-marine-700 p-6'>
                    <nav className='flex flex-col items-center self-center'>
                        ...
                        <div className='flex flex-col p-2 gap-4 bg-moss-green-300 rounded-lg'>
                            <div className={`flex flex-row h-12 gap-4 justify-center items-center w-40 p-2 ${currentPage === '/condominio' ? 'selected' : ''}`}>
            ...
            onClick={() => handlePageChange('/overview')}>Overview</Link>
                            ...
                            <div className={`flex flex-row h-12 gap-4 justify-center items-center w-40 p-2 ${currentPage === '/chat-condominio' ? 'selected' : ''}`}>
            ...
            onClick={() => handlePageChange('/chat-condominio')}>Chat</Link>
                            ...
                            <div className={`flex flex-row h-12 gap-4 justify-center items-center w-40 p-2 ${currentPage === '/pedidos-condominio' ? 'selected' : ''}`}>
            ...
            onClick={() => handlePageChange('/pedidos-condominio')}>Pedidos</Link>
                            ...
                            <div className={`flex flex-row h-12 gap-4 justify-center items-center w-40 p-2 ${currentPage === '/relatorio-condominio' ? 'selected' : ''}`}>
            ...
            onClick={() => handlePageChange('/relatorio-condominio')}>Relatório</Link>
                            ...
                            <div className={`flex flex-row h-12 gap-4 justify-center items-center w-40 p-2 ${currentPage === '/config-condominio' ? 'selected' : ''}`}>
